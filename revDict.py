...
# Search for the word ---------------------------------------------------------
while True:
    query = input('Enter the phrase to search (press x to exit): ')
    if query == 'x': break
    alpha = set(input('Enter the first letter of the expected result (press 0 to search in full dictionary): ').lower())
